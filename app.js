...
/**
 * DEVOPS HOLA MUNDO — Servidor Express de un solo archivo
 * ----------------------------------------------------------------
 * Este archivo levanta un servidor Express que responde con una
 * página HTML completa (HTML + CSS + JS embebidos como string).
 * El código que usa `document`/`window` se ejecuta en el NAVEGADOR
 * del cliente (dentro del <script> de la respuesta), nunca en Node.
 *
 * Uso:
 *   npm install express
 *   node app.js
...
// Página completa: HTML + CSS + JS del cliente, todo como string.
const PAGE_HTML = `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>Hola Mundo — Parallax</title>
<style>
  :root {
    --bg-1: #0f0c29;
    --bg-2: #302b63;
...
(function () {
  ...
  subtitle.textContent = "Una app moderna, animada y con efecto parallax — servida desde un único app.js con Express.";
...
// Única ruta: sirve la página completa.
app.get("/", (req, res) => {
  res.send(PAGE_HTML);
});
